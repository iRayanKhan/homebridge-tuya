...
class GenericAccessory {
  constructor(platform, homebridgeAccessory, deviceConfig) {
    ...
    const setTempUUID = UUIDGen.generate(this.deviceConfig.id + this.deviceConfig.name);
    ...
    if (this.homebridgeAccessory) {
      ...
      this.homebridgeAccessory = new PlatformAccessory(this.deviceConfig.name, setTempUUID, Service.Thermostat);
