...
class SimpleThermostatAccessory extends BaseAccessory {
    ...
    setTargetHeaterCoolerState(value, callback) {
        if (this.programStateNotBool == true) { this.setState(this.dpProgramState, this.scheduledHeatingOn, callback); }
        else { this.setState(this.dpProgramState, true, callback); }
    }
