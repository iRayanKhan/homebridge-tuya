...
/* Const TuyaBrightnessRange = new ValueRange(25, 255);
const HomeKitBrightnessRange = new ValueRange(0, 100);

const TuyaColorTemperatureRange = new ValueRange(0, 255);
const HomeKitColorTemperatureRange = new ValueRange(140, 500);

const TuyaSaturationRange = new ValueRange(0, 255);

const TuyaLightnessRange = new ValueRange(0, 255); */
